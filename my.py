...
passwords = ['102030', '445566',mdmonirulislam277,monirulislam121 'No match found']
keywords = [MD Monirul Islam'; June 3rd, Stonehendge', '1984; 8D; Sa???', '2C;Yankees;Flipper']
listcounts = [42808, 9875894, 9875894]
possibilities = [8768028, 9875894, 9875894]
prompt = bcolors.OKBLUE + 'root@Nibir:' + bcolors.ENDC + ' '
